import React, { type ReactNode, forwardRef, type ReactElement, useCallback, type FocusEvent, useState, useEffect } from "react";
 ...
 */
function useOnChangeContentVisibility(store: DisclosureStore, onChangeContentVisibility?: (visible: boolean) => void): void {
...
const Tooltip = forwardRef<HTMLDivElement, TooltipProps>(function SyntaxTooltip(props: TooltipProps, ref): ReactElement {
  ...
  const forwardAnchorFocusToInteractiveChild = useOnFocusForwardAnchorFocusToInteractiveChild(tooltip);
